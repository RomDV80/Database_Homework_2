...
1. Спроектировать и нарисовать схему, как в [первой домашней работе](https://github.com/netology-code/py-homeworks-db/blob/SQLPY-76/01-introduction/README.md). Прислать изображение со схемой.
